...
# 内存中执行
# 第一步：先把money.value+1 赋值给temp 然后money.value=temop
# 第二步：money.value=x
# 正常执行执行过程 money.value=5000
...
# p1:x1=money.value+1 ## x1 -> 5001
# money.value = money.value - 1
# p2:x2=money.value-1 ##x2 ->4999 #时间片没有那么听话 等把x1 赋值给了money.value之后再切换到p2
# p2:money.value=x2 ##money.value ->4999
# p1 money.value=x1  ## money.value->5001
